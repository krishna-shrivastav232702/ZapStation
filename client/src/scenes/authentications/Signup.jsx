        ...
        <form onSubmit={handleSignup} className="flex flex-col space-y-4">
          <label className="flex flex-col">
            ...
            <input
              ...
              className="p-2 bg-transparent text-black border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 placeholder-gray-400"
            />
          </label>
          ...
          <label className="flex flex-col">
            ...
            <input
              ...
              className="p-2 bg-transparent border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 placeholder-gray-400"
            />
          </label>
